(function() {
    ...
    angular
        ...
        .controller('PodiumMetricsMonitoringModalController', PodiumMetricsMonitoringModalController);

    PodiumMetricsMonitoringModalController.$inject = ['$uibModalInstance', 'threadDump'];

    function PodiumMetricsMonitoringModalController ($uibModalInstance, threadDump) {
        var vm = this;
