package org.bbmri.podium.registry.config;
    ...
    public static String getDefaultActiveProfiles(){
        if (BUILD_PROPERTIES != null) {
            ...
            if (activeProfile != null && !activeProfile.isEmpty() &&
                (activeProfile.contains(PodiumConstants.SPRING_PROFILE_DEVELOPMENT) ||
                    activeProfile.contains(PodiumConstants.SPRING_PROFILE_PRODUCTION))) {
                return activeProfile;
            }
        }
        log.warn("No Spring profile configured, running with default profile: {}", PodiumConstants.SPRING_PROFILE_DEVELOPMENT);
        return PodiumConstants.SPRING_PROFILE_DEVELOPMENT;
    }
