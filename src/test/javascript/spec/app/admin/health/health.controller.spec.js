...
describe('Controller Tests', function () {
    ...
    describe('PodiumHealthCheckController', function () {
        var $scope, podiumHealthService; // actual implementations
        var createController; // local utility functions

        beforeEach(inject(function ($injector, PodiumHealthService) {
            $scope = $injector.get('$rootScope').$new();
            podiumHealthService = PodiumHealthService;
            var locals = {
                '$scope': $scope
            };
            createController = function() {
                $injector.get('$controller')('PodiumHealthCheckController as vm', locals);
            };
            createController();
        }));
        ...
        describe('transformHealthData', function () {
            it('should flatten empty health data', function () {
                var data = {};
                var expected = [];
                expect(podiumHealthService.transformHealthData(data)).toEqual(expected);
            });
